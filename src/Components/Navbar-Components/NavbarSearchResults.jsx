...
function NavbarSearchResults({
  ...
  openedSearchResults === true
    ? (SearchResultsStatus = "showSearchResults")
    : (SearchResultsStatus = undefined);
  ...
  return (
    <div className={`NavbarSearchResults ${SearchResultsStatus}`}>
      <div className="NavbarSearchResults-intro">
        ...
        <span className="NavbarSearchResults-intro-span">
          <b>"{searchValue}"</b>
        </span>
        <span className="NavbarSearchResults-intro-span">
          generated <b>({filteredItem.length})</b> results
        </span>
      </div>
      <div className="NavbarSearchResults-results">{foundResults}</div>
    </div>
  );
}
